 ...
 * 生成当前阶段的周报
 * 
 * 用法: node tools/weekly-report.js [week_num] [theme]
 */

const fs = require('fs');
const path = require('path');

const LOGS_DIR = path.join(__dirname, '..', 'tasks', 'logs');
const ROADMAP_DIR = path.join(__dirname, '..', 'roadmap', 'evolution');
...
*此文件由 tools/weekly-report.js 生成*
`;
